...
export const BudgetTotalsMonthRunning = memo(function BudgetTotalsMonth(month: BudgetTotalsMonthProps) {
  const useBudgets = monthUtils.currentMonth() <= month.month.month;
  console.log('monthUtils.currentMonth()', monthUtils.currentMonth());
  console.log(' month.month',  month.month);
  console.log('useBudgets', useBudgets);
  console.log('month', month);
